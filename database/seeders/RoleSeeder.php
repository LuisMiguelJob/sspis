...
class RoleSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        Permission::create(['name' => 'inicio'])->syncRoles([$roleAdmin, $roleEmpleado]); // usado
        ...
        Permission::create(['name' => 'projects.index'])->syncRoles([$roleEmpleado]); // usado
        ...
        Permission::create(['name' => 'projects.workers'])->assignRole($roleEmpleado); // usado
